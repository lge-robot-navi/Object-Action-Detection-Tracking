...
class Config:
    ...
    from lib.datasets_odgt.coco import COCO as datadb
    ...
    image_max_size = 1333
    eval_resize = True
    eval_image_short_size = 480
    eval_image_max_size = 640
    ...
    from lib.utils.tf_utils import lr_policy
    max_epoch = 30
    warm_iter = 500
    ...
    TEST.RPN_PRE_NMS_TOP_N = 2000
    TEST.RPN_POST_NMS_TOP_N = 600
