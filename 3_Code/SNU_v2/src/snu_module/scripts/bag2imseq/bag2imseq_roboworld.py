...
opts_dict = {
    ...
    "paths": {
        ...
        "bag_file_base_path": "/home/kyle/roboworld_video/",
        ...
        "bag_file": "snu_description_result_video.bag",
    ...
    # Image topics
    "image_topics": {
        "input_rgb_image": "/osr/snu_input_frame",
        "detection_result_rgb_image": "/osr/snu_detection_result",
        "tracking_result_rgb_image": "/osr/snu_tracking_result",
        "aclassify_result_rgb_image": "/osr/snu_aclassify_result",
    },
        ...
        for topic, msg, t in bag.read_messages(topics=topic_name):
            ...
            if is_save is True:
                ...
                if modal.__contains__("rgb") is True:
                    ...
                    curr_frame_file_path = os.path.join(modal_save_dir, "rgb_image__%09d.png" % fidx_count)
